...
* Black Deaths (the yellow zombies) hit will reduce vitality instead of max hp. (inspired by <https://github.com/diasurgical/devilutionX/pull/1645/files>)
* Fascinating Shrine, Ornate Shine and Sacred Shrine reduce magic instead of max mana. (inspired by <https://github.com/diasurgical/devilutionX/pull/1645/files>) The max magic loss is limited to 10.
